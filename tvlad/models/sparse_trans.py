...
import tvlad.models.configs as configs
import torchvision.transforms as T
from tvlad.models.mobilenetv3 import MobileNetV3_Large
from tvlad.utils.serialization import load_checkpoint, copy_state_dict
...
class Embeddings(nn.Module):
    ...
    """
    def __init__(self, config, img_size, in_channels=1024): # set 'in_channels' for the input of TransVLAD
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=(128,512), tuple_size=1, vis=False):
